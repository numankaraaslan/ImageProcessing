...
public class Message_box
{
    ...
    public static void show( String mesaj, String baslik, int message_type )
    {
        ...
        {
            new_stage.getIcons().add( new Image( ImageProcessing.class.getResourceAsStream( "imgs/warning.png" ) ) );
        }
        else if ( message_type == info_message )
        {
            new_stage.getIcons().add( new Image( ImageProcessing.class.getResourceAsStream( "imgs/info.png" ) ) );
        }
