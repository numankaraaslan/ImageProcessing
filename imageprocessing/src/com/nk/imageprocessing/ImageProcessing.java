						...
						for (int i = 0; i < number_of_operations; i++)
						{
							...
							if (i < loaded_ops)
							{
								...
								else if (op_infos.get(i).startsWith(Operation_types.op_convolution))
								{
									...
									{ Double.parseDouble(op_infos.get(i).split(";")[ 1 ].split(",")[ 0 ]), Double.parseDouble(op_infos.get(i).split(";")[ 1 ].split(",")[ 1 ]), Double.parseDouble(op_infos.get(i).split(";")[ 1 ].split(",")[ 2 ]) };
									convolution_matrix[ 1 ] = new double[]
									{ Double.parseDouble(op_infos.get(i).split(";")[ 1 ].split(",")[ 3 ]), Double.parseDouble(op_infos.get(i).split(";")[ 1 ].split(",")[ 4 ]), Double.parseDouble(op_infos.get(i).split(";")[ 1 ].split(",")[ 5 ]) };
									convolution_matrix[ 2 ] = new double[]
									{ Double.parseDouble(op_infos.get(i).split(";")[ 1 ].split(",")[ 6 ]), Double.parseDouble(op_infos.get(i).split(";")[ 1 ].split(",")[ 7 ]), Double.parseDouble(op_infos.get(i).split(";")[ 1 ].split(",")[ 8 ]) };
